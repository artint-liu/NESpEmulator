...
std::array<CPU::Operation, 256> CPU::opTable{
    ...
    Operation{.name = "NOP", .addressing = Addressing::Zp0, .instruction = &CPU::_NOP, .cycle = 3, .pageCycle = 0},
    ...
    Operation{.name = "NOP", .addressing = Addressing::Abs, .instruction = &CPU::_NOP, .cycle = 4, .pageCycle = 0},
    ...
    Operation{.name = "NOP", .addressing = Addressing::Zpx, .instruction = &CPU::_NOP, .cycle = 4, .pageCycle = 0},
    ...
    Operation{.name = "NOP", .addressing = Addressing::Imp, .instruction = &CPU::_NOP, .cycle = 2, .pageCycle = 0},
    Operation{.name = "???", .addressing = Addressing::Aby, .instruction = &CPU::NIL, .cycle = 7, .pageCycle = 0},
    Operation{.name = "NOP", .addressing = Addressing::Abx, .instruction = &CPU::_NOP, .cycle = 4, .pageCycle = 1},
    ...
    Operation{.name = "???", .addressing = Addressing::Imp, .instruction = &CPU::NIL, .cycle = 2, .pageCycle = 0},
    Operation{.name = "???", .addressing = Addressing::Izx, .instruction = &CPU::NIL, .cycle = 8, .pageCycle = 0},
    Operation{.name = "BIT", .addressing = Addressing::Zp0, .instruction = &CPU::_BIT, .cycle = 3, .pageCycle = 0},
    ...
    Operation{.name = "???", .addressing = Addressing::Imm, .instruction = &CPU::NIL, .cycle = 2, .pageCycle = 0},
    Operation{.name = "BIT", .addressing = Addressing::Abs, .instruction = &CPU::_BIT, .cycle = 4, .pageCycle = 0},
    ...
    Operation{.name = "???", .addressing = Addressing::Abx, .instruction = &CPU::NIL, .cycle = 7, .pageCycle = 0},
    Operation{.name = "NOP", .addressing = Addressing::Imm, .instruction = &CPU::_NOP, .cycle = 2, .pageCycle = 0},
    ...
    Operation{.name = "DEC", .addressing = Addressing::Zp0, .instruction = &CPU::_DEC, .cycle = 5, .pageCycle = 0},
    Operation{.name = "???", .addressing = Addressing::Zp0, .instruction = &CPU::NIL, .cycle = 5, .pageCycle = 0},
    ...
    Operation{.name = "DEC", .addressing = Addressing::Abs, .instruction = &CPU::_DEC, .cycle = 6, .pageCycle = 0},
    Operation{.name = "???", .addressing = Addressing::Abs, .instruction = &CPU::NIL, .cycle = 6, .pageCycle = 0},
    ...
    Operation{.name = "DEC", .addressing = Addressing::Zpx, .instruction = &CPU::_DEC, .cycle = 6, .pageCycle = 0},
    Operation{.name = "???", .addressing = Addressing::Zpx, .instruction = &CPU::NIL, .cycle = 6, .pageCycle = 0},
    ...
    Operation{.name = "DEC", .addressing = Addressing::Abx, .instruction = &CPU::_DEC, .cycle = 7, .pageCycle = 0},
    Operation{.name = "???", .addressing = Addressing::Abx, .instruction = &CPU::NIL, .cycle = 7, .pageCycle = 0},
...
void CPU::_BIT(std::uint16_t address) {
    std::uint8_t m = read(address);
    status.z = (m & a) == 0;
    status.v = (m >> 6) & 1;
    status.n = (m >> 7) & 1;
...
void CPU::_DEC(std::uint16_t address) {
    std::uint8_t m = read(address);
    m--;
    write(address, m);
